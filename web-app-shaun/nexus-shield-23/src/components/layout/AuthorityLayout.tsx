...
export const AuthorityLayout = () => {
  ...
  if (path === '/incidents') return t('incidents');
  if (path === '/heatmap') return t('heatmap');
  if (path === '/digital-ids') return t('digitalIds');
  if (path === '/zones') return t('zones');
  if (path === '/operator') return t('operator');
  if (path === '/audit') return t('audit');
