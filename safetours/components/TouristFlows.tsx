        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <Button
              ...
              onClick={() =>
                handleFlowAction("Registration", "New Tourist Arrival")
              }
            >
            ...
            <Button
              ...
              className="w-full justify-start"
              onClick={() =>
                handleFlowAction("Registration", "Digital ID Creation")
              }
            >
            ...
            <Button
              ...
              className="w-full justify-start"
              onClick={() =>
                handleFlowAction("Registration", "Blockchain Verification")
              }
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setTouristData({ ...touristData, name: e.target.value })
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setTouristData({ ...touristData, passport: e.target.value })
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setTouristData({ ...touristData, phone: e.target.value })
                }
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setTouristData({ ...touristData, email: e.target.value })
                }
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(value: any) =>
                  setTouristData({ ...touristData, language: value })
                }
              >
                <SelectTrigger>
                  <SelectValue />
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                Enable continuous location sharing for enhanced safety
                monitoring
              </p>
            </div>
            <Button
              ...
              onClick={() =>
                setTouristData({
                  ...touristData,
                  locationSharing: !touristData.locationSharing,
                })
              }
            >
                ...
                <div className="flex gap-2 mt-2 sm:mt-0">
                  ...
                  {tourist.checkInStatus === "overdue" && (
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        handleFlowAction("Check-in", `Contact ${tourist.name}`)
                      }
                    >
